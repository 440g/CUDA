...
int main() {
    ...
    Sphere *dev_s = nullptr;

    HANDLE_ERROR(cudaMalloc((void**)&dev_bitmap, bitmap.image_size()));
    data.dev_bitmap = dev_bitmap;

    HANDLE_ERROR(cudaMalloc((void**)&dev_s, sizeof(Sphere) * SPHERES));
    ...
    HANDLE_ERROR(cudaMemcpy(dev_s, temp_s, sizeof(Sphere) * SPHERES, cudaMemcpyHostToDevice));
    free(temp_s);
